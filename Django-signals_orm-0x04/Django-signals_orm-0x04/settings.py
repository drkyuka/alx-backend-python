...
SECRET_KEY = "django-insecure-qf#$$l!v#xls@wdyf@()@mw0x!d7fzv_d(81qtxyr=%s_4ty8d"
...
INSTALLED_APPS = [
    ...
    "chats.apps.ChatsConfig",  # Custom app for chat functionality
    "messaging.apps.MessagingConfig",  # Custom app for messaging functionality
]

REST_FRAMEWORK = {
    "DEFAULT_AUTHENTICATION_CLASSES": [
        "chats.auth.CustomJWTAuthentication",  # Custom JWT authentication
...
# User chat users as custom user model
